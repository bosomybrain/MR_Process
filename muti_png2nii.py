...
def muti_png2nii_all(label_path, output_path):
    ...
    for f in files:
        ...
        # print(num_picture)
        if num_picture == len(files):  # 对最后一个病例单独讨论
...
if __name__ == '__main__':
    ...
    # muti_png2nii(files,output_path1)
